...
pub trait IntegralDomain<Oa: Operator, Om: Operator>: CommutativeRing<Oa, Om> {}
...
/// irreducibles.
pub trait UniqueFactorizationDomain<Oa: Operator, Om: Operator>: IntegralDomain<Oa, Om> {}

/// A principal ideal domain: an integral domain whose ideals are all
/// principal (every ideal is generated by a single element).
pub trait PrincipalIdealDomain<Oa: Operator, Om: Operator>:
